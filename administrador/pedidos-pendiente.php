...
<head>
    ...
    <script>
        ...
        function popUpWindow(URLStr,left,top,width,height) {
            if (popUpWin) {
                if (!popUpWin.close) popUpWin.close();
            }
            popUpWin=open(URLStr,'popUpWin','tollbar=no,location,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,width='+600+',height='+600+',left='+left+',top='+top+',screenX='+left+',screenY='+top+'');
        }
    </script>
</head>
<body>
                        ...
                        <div>
                            ...
                            <div>
                                <table class="datatable-1 table">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql="SELECT *,o.id as pedidosid from `productos` p, `pedidos` o, `usuarios` u where p.id=productoId and usuarioId=u.id and pedidoEstado in ('Pendiente', null)";
